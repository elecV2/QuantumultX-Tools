/**
 * 名称：baidu.user.js
 * 源址：https://userstyles.org/styles/userjs/178663/pure.user.js
 * 
 * 制作：elecV2
 *
...
[rewrite]
^https?:\/\/.*\.baidu\.com url script-response-body baidu.user.js
...
// ==/UserScript==
(function() {var css = ".icon-bdad, div[class*=youx], div[class*=ads], div[class*=recommend]{display: none !important;}";
