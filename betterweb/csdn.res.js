...
if (typeof $response !== 'undefined') {
  ...
  if (/<\/html>|<\/body>/.test(body)) {
    ...
    body = body.replace('</head>', `<style type="text/css">*{max-width:100%!important;min-width: initial !important;box-sizing:border-box}html{overflow-y:auto!important}body{-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;position:absolute!important;top:0!important;width: 100%;}.more-toolbox,.blog-footer-bottom,.csdn-side-toolbar,.slide-content-box,.blog-tags-box, .operating, #blog_detail_zk_collection,.article-copyright,#csdn-toolbar, aside, .tool-box,.template-box ${ config.recommendblock ? ',.recommend-box, .recommend-tit-mod' : '' }{display:none !important}main,.content{width:100% !important}.blog_title_box{width:unset !important}#mainBox {margin-left: 0;}.blog-content-box {padding: 0 8px !important;}</style></head>`)
