...
if (typeof $response !== 'undefined') {
  ...
  domstyle.innerHTML = css_for_stackoverflow
  document.head.appendChild(domstyle)
} else {
  console.log('stackoverflow.js 用于重写(rewrite) 网络请求，或者在浏览器插件中使用，请勿直接运行该脚本\n问题反馈: https://t.me/elecV2')
